...
// }
function loginjs() {
  return gulp.src(envOptions.loginjavascript.src).pipe($.concat(envOptions.loginjavascript.concat)).pipe(gulp.dest(envOptions.loginjavascript.path))
}
function backjs() {
  return gulp.src(envOptions.backjavascript.src).pipe($.concat(envOptions.backjavascript.concat)).pipe(gulp.dest(envOptions.backjavascript.path))
}
function vendorsJs() {
...
function watch() {
  ...
  gulp.watch(envOptions.loginjavascript.src, gulp.series(loginjs))
  gulp.watch(envOptions.backjavascript.src, gulp.series(backjs))
...
exports.build = gulp.series(clean, copyFile, layoutHTML, sass, loginjs, backjs, vendorsJs)

exports.default = gulp.series(clean, copyFile, layoutHTML, sass, loginjs, backjs, vendorsJs, gulp.parallel(browser, watch))
